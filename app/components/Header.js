  ...
  return (
    <header className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-12">
      <div className="container mx-auto px-4 text-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-4">Vinay kumar</h1>
        <h2 className="text-2xl md:text-3xl font-semibold mb-6">Senior Software Engineer (MERN)</h2>
        <p className="text-xl max-w-3xl mx-auto">
          Full-stack developer specializing in React, Node.js, and cloud technologies with 3+ years of experience building scalable web applications.
        </p>
